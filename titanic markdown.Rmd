...
query5 = "select pclass, survived, avg(age) as avg_age from titanic_yourlastname
          where survived=1
          group by pclass, survived;"
...
query7 = "select name, pclass, survived, age from titanic_yourlastname 
...
query9 = "select name, pclass, survived, age from titanic_yourlastname 
          where name regexp ',.*Ivar.*$';"
